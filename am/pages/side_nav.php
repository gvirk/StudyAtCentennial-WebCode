...
echo '<div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="tables.html"><i class="fa fa-table fa-fw"></i> Events</a>
                        </li>
                        <li>
                            <a href="forms.html"><i class="fa fa-edit fa-fw"></i> Forms <span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">Categories</a>
                                </li>
                                <li>
                                    <a href="morris.html">Topics</a>
                                </li>
                                <li>
                                    <a href="morris.html">Comments</a>
                                </li>
                            </ul>
                        </li>
                        <li>
